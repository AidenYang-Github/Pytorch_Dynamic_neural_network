...
if __name__ == '__main__':
    ...
    for t in range(10001):
        ...
        if t % 200 == 0:
            ...
            plt.text(-0.25, 0.4, 'Loss_SGD=%.6f' % loss_SGD.data.numpy(), fontdict={'size': 20, 'color': 'red'})
            plt.text(-0.25, 0.6, 'loss_Momentum=%.6f' % loss_Momentum.data.numpy(), fontdict={'size': 20, 'color': 'yellow'})
            plt.text(-0.25, 0.8, 'loss_RMSprop=%.6f' % loss_RMSprop.data.numpy(), fontdict={'size': 20, 'color': 'green'})
            plt.text(-0.25, 1, 'loss_Adam=%.6f' % loss_Adam.data.numpy(), fontdict={'size': 20, 'color': 'magenta'})
        ...
        #     plt.grid()
        #     plt.scatter(x.data.numpy(), y.data.numpy())
        #     plt.plot(x.data.numpy(), prediction_Momentum.data.numpy(), 'r-.', lw=3)
        #     plt.text(-0.25, 1, 'loss_Momentum=%.6f' % loss_Momentum.data.numpy(), fontdict={'size': 20, 'color': 'red'})
        #     plt.pause(0.1)
        #
        # if t % 200 == 0:
        #     plt.cla()
        ...
        #     plt.grid()
        #     plt.scatter(x.data.numpy(), y.data.numpy())
        #     plt.plot(x.data.numpy(), prediction_RMSprop.data.numpy(), 'r-.', lw=3)
        #     plt.text(-0.25, 1, 'loss_RMSprop=%.6f' % loss_RMSprop.data.numpy(), fontdict={'size': 20, 'color': 'red'})
        #     plt.pause(0.1)
        #
        # if t % 200 == 0:
        #     plt.cla()
        ...
        #     plt.grid()
        #     plt.scatter(x.data.numpy(), y.data.numpy())
        #     plt.plot(x.data.numpy(), prediction_Adam.data.numpy(), 'r-.', lw=3)
        #     plt.text(-0.25, 1, 'loss_Adam=%.6f' % loss_Adam.data.numpy(), fontdict={'size': 20, 'color': 'red'})
        #     plt.pause(0.1)
