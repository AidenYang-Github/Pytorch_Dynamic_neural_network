...
if __name__ == "__main__":
    ...
    net_1 = Net(1, 150, 1)
    optimizer_1 = torch.optim.Adam(net_1.parameters(), lr=LR_1, betas=Beta_1)
    loss_func_1 = torch.nn.MSELoss()

    net_2 = Net(1, 250, 1)
    optimizer_2 = torch.optim.Adam(net_2.parameters(), lr=LR_2, betas=Beta_2)
    loss_func_2 = torch.nn.MSELoss()

    net_3 = Net(1, 500, 1)
    optimizer_3 = torch.optim.Adam(net_3.parameters(), lr=LR_3, betas=Beta_3)
