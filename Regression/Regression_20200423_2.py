...
if __name__ == "__main__":
    ...
    net_1 = Net(1, 500, 1)
    optimizer_1 = torch.optim.RMSprop(net_1.parameters(), lr=0.05, alpha=0.93)
    loss_func_1 = torch.nn.MSELoss()

    net_2 = Net(1, 500, 1)
    optimizer_2 = torch.optim.RMSprop(net_2.parameters(), lr=0.05, alpha=0.95)
    loss_func_2 = torch.nn.MSELoss()

    net_3 = Net(1, 500, 1)
    optimizer_3 = torch.optim.RMSprop(net_3.parameters(), lr=0.05, alpha=0.97)
